...
class Jadwal_model extends CI_Model
{
  ...
  public function get_dokter()
  {
    ...
    $k = trim($id);
    $Hari = trim($hari);
    $data = $this->db->query("SELECT b_ms_unit.id,b_ms_unit.nama,b_ms_jadwal_dokter.hari,b_ms_jadwal_dokter.mulai,b_ms_jadwal_dokter.selesai,b_ms_pegawai.nama,b_ms_jadwal_dokter.aktif,
    ...
    return $data; // return berupa array objek
  }
